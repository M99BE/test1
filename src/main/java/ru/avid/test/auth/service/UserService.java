package ru.avid.test.auth.service;
...
import ru.avid.test.auth.repository.ActivityRepository;
import ru.avid.test.auth.repository.RoleRepository;
import ru.avid.test.auth.repository.UserRepository;
